...
pub trait AdvWrite {
    fn w_go_str(&mut self,x:u16,y:u16,string: &str);
    fn w_str_go(&mut self,x:u16,y:u16,string: &str);
    fn w_go_str_color<T: color::Color>(&mut self,x:u16,y:u16,string: &str,fg: Option<T>,bg: Option<T>);
    fn w_str_go_color<T: color::Color>(&mut self,x:u16,y:u16,string: &str,fg: Option<T>,bg: Option<T>);
