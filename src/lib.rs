...
pub trait AdvWrite {
    ...
    fn w_go_str_color<T: color::Color,Q: color::Color>(&mut self,x:u16,y:u16,string: String,fg: Option<T>,bg: Option<Q>);
    fn w_str_go_color<T: color::Color,Q: color::Color>(&mut self,x:u16,y:u16,string: String,fg: Option<T>,bg: Option<Q>);
